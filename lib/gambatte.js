...
function integrateWasmJS() {
  ...
  var wasmTextFile = 'gambatte.wast';
  var wasmBinaryFile = 'gambatte.wasm';
  var asmjsCodeFile = 'gambatte.temp.asm.js';
...
/* global initializers */  __ATINIT__.push({ func: function() { ___cxx_global_var_init() } }, { func: function() { ___cxx_global_var_init_1() } }, { func: function() { ___cxx_global_var_init_2() } }, { func: function() { __GLOBAL__sub_I_state_osd_elements_cpp() } }, { func: function() { __GLOBAL__sub_I_statesaver_cpp() } });
...
Module['wasmTableSize'] = 2177;

Module['wasmMaxTableSize'] = 2177;
...
var real__gambatte_boot = asm["_gambatte_boot"]; asm["_gambatte_boot"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__gambatte_boot.apply(null, arguments);
};
...
Module["asm"] = asm;
var __GLOBAL__sub_I_state_osd_elements_cpp = Module["__GLOBAL__sub_I_state_osd_elements_cpp"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["__GLOBAL__sub_I_state_osd_elements_cpp"].apply(null, arguments) };
...
var _gambatte_boot = Module["_gambatte_boot"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_gambatte_boot"].apply(null, arguments) };
